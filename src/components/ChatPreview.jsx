...
/**
 * ChatPreview — prelaunch educational briefing for the Chat tab.
 *
 * Before the game starts, the lobby is a ghost town. Instead of showing
 * "No messages yet" with no context, this component explains:
 *   1. What the survivors lobby is and when it comes alive
 *   2. The two modes: Lobby (broadcast) vs DM (private via World Chat)
 *   3. What game-time chat looks like — example messages that show
 *      strategic calls, sus callouts, and banter
 *   4. The rules: visible to all survivors, no photos off-platform
 *
 * The input bar below remains functional — if someone wants to be first,
 * they can still type and send.
 */
