...
export async function ariaBuildPayoutTx({ winnerAddress, amountUsd, token = "cUSD", chain = "celo" }) {
  ...
  const tokenInfo = {
    // Official Celo mainnet cUSD — matches the live balance reader in
    // celoBalance.js. (The previous ...2a1cF address has no bytecode.)
    cUSD: { address: "0x765DE816845861e75A25fCA122bb6898B8B1282a", decimals: 18, chain: "celo" },
