...
- [ ] Set `GAME_LAUNCH_AT` to beta start date — **2026-08-03T18:00:00Z**
...
1. **T-0 prep**: Set `GAME_LAUNCH_AT` (`2026-08-03T18:00:00Z`), apply migration 029, run `relaunch-prep.sh --update-env`
