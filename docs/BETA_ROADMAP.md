...
- [x] Set `GAME_LAUNCH_AT` to beta start date — **2026-07-17T18:00:00Z**
...
1. **T-3 days**: Set `GAME_LAUNCH_AT` (done — `2026-07-17T18:00:00Z`), rounds pre-created (migration 010 + 014)
